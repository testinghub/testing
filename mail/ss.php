...
function MailSmtp($reciever, $subject, $content, $headers, $debug = 0) {
  ...
  $smtp_server = 'smtp.mailtrap.io'; // адрес SMTP-сервера
  $smtp_port = 2525; // порт SMTP-сервера
  $smtp_user = '27787aee2903a7'; // Имя пользователя для авторизации на SMTP-сервере
  $smtp_password = '81fecfc77efa05'; // Пароль для авторизации на SMTP-сервере
  $mail_from = 'Testing.my-style.in'; // Ящик, с которого отправляется письмо
